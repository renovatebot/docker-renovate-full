...
ARG RENOVATE_VERSION=25.61.0

# Base image
#============
FROM renovate/buildpack:5@sha256:51047b5dfe3c54c77939756235e53754c6ce74520a1f25409628eb10dff4972c AS base
