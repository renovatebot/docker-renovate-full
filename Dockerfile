...
# update trigger
FROM renovate/renovate:23.73.2-slim@sha256:f6d6b69cb310c799d28f78d5a266882f15d365f961d4b1dc7f5b2eaf05ce142e
...
RUN install-tool composer 2.0.5
...
# renovate: datasource=pypi
RUN install-pip pipenv 2020.11.4
