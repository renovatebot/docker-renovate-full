...
ARG RENOVATE_VERSION=32.111.1

# Base image
#============
FROM renovate/buildpack:6@sha256:87bef922665476c82bc1aa9dbee85d04be57c4d9f1147b964ac6cda63db3cc83 AS base
