...
ARG RENOVATE_VERSION=35.58.2

# Base image
#============
FROM ghcr.io/containerbase/base:7.8.4@sha256:b11860aed3f6bb5129c087b1ac434105d9459b7f09ce6292b9c50d22555fec65 AS base
...
RUN install-tool pipenv 2023.4.20
