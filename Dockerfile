...
ARG RENOVATE_VERSION=32.76.0

# Base image
#============
FROM renovate/buildpack:6@sha256:5341b837a42cd0feac1897b3477d79ec910c6f806dd8d3bfbd69efda723b164b AS base
