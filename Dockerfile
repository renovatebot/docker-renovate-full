...
ARG RENOVATE_VERSION=34.154.3

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.3.3@sha256:59ff364ac24bd8eddcbbe22768466ebfc9ce1bd551007dee8c4a5703b8a2a6ab AS base
