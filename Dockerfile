...
ARG RENOVATE_VERSION=32.31.1

# Base image
#============
FROM renovate/buildpack:6@sha256:8ffd446a87786b9ea68c5c4058ee47eec3fd8f22cb74232f7541f722d04d1bd2 AS base
...
RUN install-pip pipenv 2022.4.21
