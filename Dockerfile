...
ARG RENOVATE_VERSION=36.1.5

# Base image
#============
FROM ghcr.io/containerbase/base:9.1.3@sha256:cda51b60f9bc6fc7b9b3134617abf910a0b467ef56e466b12f36876bb1dc2418 AS base
...
RUN install-tool pipenv 2023.7.4
...
# renovate: datasource=npm versioning=npm
RUN install-tool pnpm 8.6.6

# renovate: datasource=npm versioning=npm
RUN install-tool lerna 7.1.1
