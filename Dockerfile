...
ARG RENOVATE_VERSION=35.82.0

# Base image
#============
FROM ghcr.io/containerbase/base:7.9.1@sha256:e7009883e2e9c37cced69327f56d339e6fc3652926905f4f517129f8ac3dee1a AS base
...
RUN install-tool erlang 25.3.2.0
