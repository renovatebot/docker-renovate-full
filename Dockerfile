...
ARG RENOVATE_VERSION=36.40.3

# Base image
#============
FROM ghcr.io/containerbase/base:9.10.1@sha256:4c738b34bb84da4fd5901328edf16181566cf0db95302084e8d5479e12a31046 AS base
