...
ARG RENOVATE_VERSION=25.38.2

# Base image
#============
FROM renovate/buildpack:5@sha256:594f4f38a4ea7383388a05ff511072adf68b53d37d8d8755992201a7a5ee3e3f AS base
...
RUN install-tool composer 2.1.2
