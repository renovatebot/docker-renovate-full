...
ARG RENOVATE_VERSION=32.10.2

# Base image
#============
FROM renovate/buildpack:6@sha256:e74995e980b0c92a878bbed8d8de3a19a3f7138a2e9fd4fc19ececbb28add033 AS base
...
RUN install-tool composer 2.2.10
