...
ARG RENOVATE_VERSION=34.119.5

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.0.7@sha256:5e7772273c0371447f7a7072c83687e57dfce5c020d62d816653678337a7e42f AS base
