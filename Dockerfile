...
ARG RENOVATE_VERSION=34.118.1

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.0.3@sha256:4e3e3ad2d83863d7301fffd90ed160a3c47553ba87d5f3fdbefcdd647152fe00 AS base
