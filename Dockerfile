...
ARG RENOVATE_VERSION=28.0.3

# Base image
#============
FROM renovate/buildpack:5@sha256:4f0d2d1489f5f46bc1eaa662935af526e028e9498eb57735938102683c21c811 AS base
...
RUN install-tool php 7.4.24

# renovate: datasource=github-releases lookupName=composer/composer
RUN install-tool composer 2.1.9

# renovate: datasource=docker versioning=docker
RUN install-tool golang 1.17.2
...
# renovate: datasource=pypi
RUN install-pip pip-tools 6.3.1
...
RUN install-tool dotnet 3.1.414
