...
ARG RENOVATE_VERSION=32.6.12

# Base image
#============
FROM renovate/buildpack:6@sha256:33fd07dbab9b62e84eb346255d8a0f9b47aede116cc437adb7c19ca577896957 AS base
...
RUN install-tool docker 20.10.13
...
RUN install-tool composer 2.2.9

# renovate: datasource=docker versioning=docker
RUN install-tool golang 1.18.0

# renovate: datasource=github-releases lookupName=containerbase/python-prebuild
RUN install-tool python 3.10.3
...
RUN install-gem bundler 2.3.10
