...
ARG RENOVATE_VERSION=32.22.0

# Base image
#============
FROM renovate/buildpack:6@sha256:2f71076c04e6835621d4775827c024d7a219f65a957cc38a5dcb7305f0bf0bad AS base
