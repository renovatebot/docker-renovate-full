...
ARG RENOVATE_VERSION=28.1.8

# Base image
#============
FROM renovate/buildpack:5@sha256:3b1bbce27d7612f261f70552c4cdea6415593c8fe42b7f094a22ead8782ca3ca AS base
