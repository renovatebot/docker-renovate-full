...
ARG RENOVATE_VERSION=32.190.1

# Base image
#============
FROM renovate/buildpack:6@sha256:ae02fc267362653858eb05e717e13778baa8b63e96123ec4d7a59abd77bbee49 AS base
...
RUN install-pip pipenv 2022.9.2
