...
ARG RENOVATE_VERSION=32.195.0

# Base image
#============
FROM renovate/buildpack:6@sha256:c1e1eb6659fc36d40f980038e27bb4368ddbbf6536e2a6c941750a7713789fde AS base
...
RUN install-pip pipenv 2022.9.8
