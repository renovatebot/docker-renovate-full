...
ARG RENOVATE_VERSION=35.159.7

# Base image
#============
FROM ghcr.io/containerbase/base:9.9.1@sha256:18dec174dead1b41480dc35e7b96521a7b0227e01e7fd12343a7bc689773dc0e AS base
...
RUN install-tool bundler 2.4.18
