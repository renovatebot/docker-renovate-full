...
ARG RENOVATE_VERSION=31.21.0

# Base image
#============
FROM renovate/buildpack:5@sha256:be0521a13e457332c7a1fb136fbc0a79472fcbdeaca628c053ab61b6fd48adf7 AS base
