...
ARG RENOVATE_VERSION=26.10.0

# Base image
#============
FROM renovate/buildpack:5@sha256:ca864d8398d4bb06a7787d6834d8c80ae6aadadeed5dbc8b9131acf9946ab6ec AS base
