...
ARG RENOVATE_VERSION=25.70.2

# Base image
#============
FROM renovate/buildpack:5@sha256:4cce76b83ec71a439e182c3224449917ec9610110cf06dbf21739b722f194b52 AS base
