...
ARG RENOVATE_VERSION=29.17.0

# Base image
#============
FROM renovate/buildpack:5@sha256:100fc8f4d6b25ffeadab4eff7fbc9adfdb61b84ed6e5d9199290e02e9ac49c8e AS base
