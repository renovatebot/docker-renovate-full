...
ARG RENOVATE_VERSION=34.158.2

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.3.7@sha256:6e93c9ab5d9c0f11688f1eedec8eed37afc4681cd243a857a53e8701bc7f6485 AS base
