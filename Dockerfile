...
ARG RENOVATE_VERSION=32.160.2

# Base image
#============
FROM renovate/buildpack:6@sha256:1922ea7accc3245856ccfed61c2bd37962d510eb6216a86d69ecebc029bfe66b AS base
...
RUN install-tool composer 2.4.0
...
RUN install-pip pipenv 2022.8.15
...
RUN install-gem bundler 2.3.20
