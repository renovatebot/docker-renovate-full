...
ARG RENOVATE_VERSION=26.18.3

# Base image
#============
FROM renovate/buildpack:5@sha256:c60d8507223bf9b1c0ca555cb20789a2eaaaa8a3702672dd9a4d7c9b140345f7 AS base
