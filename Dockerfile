...
ARG RENOVATE_VERSION=32.45.5

# Base image
#============
FROM renovate/buildpack:6@sha256:da38140d4f078d577019700c38c9c4471c0947c5b0c91eee352a84252c4bc114 AS base
...
RUN install-tool node v16.15.0
