...
ARG RENOVATE_VERSION=32.73.4

# Base image
#============
FROM renovate/buildpack:6@sha256:fd3ecf7756539161dcc747890f7485c03284abed0d5b991b02926266f1f8e766 AS base
...
RUN install-gem bundler 2.3.15
