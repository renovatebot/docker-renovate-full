...
ARG RENOVATE_VERSION=32.217.0

# Base image
#============
FROM renovate/buildpack:6@sha256:359d7d64a7abcf67de2e0ae60de5372ab6da5eee1dcbb52c5d93187e1fff3796 AS base
...
RUN install-tool erlang 24.3.4.5
...
RUN install-pip pipenv 2022.10.4
