...
ARG RENOVATE_VERSION=31.60.0

# Base image
#============
FROM renovate/buildpack:6@sha256:afa70a0dc7d646629e5d507928275c4c8c3472f061b2390d15c64e599d61a10b AS base
