...
ARG RENOVATE_VERSION=31.66.3

# Base image
#============
FROM renovate/buildpack:6@sha256:5bf8905259d30781df51f06dcec57f085b328584a60e43d829947538d2b5c640 AS base
