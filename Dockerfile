...
ARG RENOVATE_VERSION=32.52.1

# Base image
#============
FROM renovate/buildpack:6@sha256:ceff8531020887fd47404fb3ed5a5f97de4ddcf32211bab0c1c89824963aac5b AS base
...
RUN install-tool docker 20.10.16
...
RUN install-pip pipenv 2022.5.2
...
# renovate: datasource=pypi
RUN install-pip pip-tools 6.6.1
...
RUN install-gem bundler 2.3.13
...
# renovate: datasource=npm versioning=npm
RUN install-tool pnpm 6.32.11

# renovate: datasource=npm versioning=npm
RUN install-npm lerna 4.0.0

# renovate: datasource=github-releases lookupName=helm/helm
RUN install-tool helm v3.8.2
