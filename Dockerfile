...
ARG RENOVATE_VERSION=34.73.3

# Base image
#============
FROM ghcr.io/containerbase/buildpack:5.10.0@sha256:ec76a4f53317eb8a76f91d74d25382269a99b86c60564260423b7f65fe5f0737 AS base
...
RUN install-tool bundler 2.4.1
