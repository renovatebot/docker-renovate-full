...
ARG RENOVATE_VERSION=34.154.1

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.3.2@sha256:f9fe56e4efa9ec2a05f529c1e4bee8a6a066fe791949fb8726be3b90cb53fe1b AS base
