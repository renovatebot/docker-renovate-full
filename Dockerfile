...
ARG RENOVATE_VERSION=32.201.2

# Base image
#============
FROM renovate/buildpack:6@sha256:d8eb54a4a9aa9819b57120531fae280680d7246015405b84c64b3df3833ebd28 AS base
...
RUN install-pip pipenv 2022.9.21
