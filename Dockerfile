...
ARG RENOVATE_VERSION=31.68.4

# Base image
#============
FROM renovate/buildpack:6@sha256:fa5ad9fcfbdf0f1833d53f6a70986658fb8083d5465058ed0eb75d30ad5e97b6 AS base
...
# renovate: datasource=pypi
RUN install-pip pip-tools 6.5.0
