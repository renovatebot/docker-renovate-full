...
ARG RENOVATE_VERSION=29.13.4

# Base image
#============
FROM renovate/buildpack:5@sha256:f00fa0759fd02737867f47b67bc239aaf8b76b1bfcaf200f735d81b96358a8e0 AS base
...
RUN install-tool composer 2.1.12
