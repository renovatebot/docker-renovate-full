...
ARG RENOVATE_VERSION=34.68.0

# Base image
#============
FROM ghcr.io/containerbase/buildpack:5.4.0@sha256:07c37578932d75be2e6a4b0f9c627ba3dbef4d306158035f1b96b8b69cd99834 AS base
