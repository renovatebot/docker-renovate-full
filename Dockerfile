...
ARG RENOVATE_VERSION=34.0.0

# Base image
#============
FROM renovate/buildpack:6@sha256:c831b621e16266121d75c4aaf2d53827b86f9f9c77b0c6004716de5c1b292737 AS base
...
RUN install-tool java 17.0.4+101
