...
# Base image
#============
FROM ghcr.io/containerbase/base:7.5.0@sha256:dc6aab2201aa8357454536b02242377aa168c3f474b852f20c971316df9911d7 AS base
...
RUN install-tool docker 23.0.2
...
RUN install-tool bundler 2.4.10
