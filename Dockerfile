...
ARG RENOVATE_VERSION=25.52.8

# Base image
#============
FROM renovate/buildpack:5@sha256:f0671c4f8edc10fee31c95384bfc994c5b395443a1b7ead81db85c757a0ca71b AS base
