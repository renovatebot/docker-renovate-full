...
ARG RENOVATE_VERSION=34.143.0

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.1.4@sha256:84ac72438f0d9a39ab820b009c1ae3c75e322e334b5249a5fc9f75c928712fbf AS base
