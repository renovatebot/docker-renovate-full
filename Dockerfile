...
ARG RENOVATE_VERSION=34.56.1

# Base image
#============
FROM ghcr.io/containerbase/buildpack:5.2.4@sha256:d81d3fa0f6b98db4bdca00de54cac0dd9d1a064d8b4731ae14c13cc8367d6b1c AS base
