...
ARG RENOVATE_VERSION=34.153.0

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.3.0@sha256:b04fd349a1562141276094036d105535df492ac11fd7d23f158c418686f34493 AS base
