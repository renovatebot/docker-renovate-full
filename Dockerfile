...
ARG RENOVATE_VERSION=32.103.2

# Base image
#============
FROM renovate/buildpack:6@sha256:125859ce067bc29523130c09470cb9664368e8103f65355236a04b1757c9af23 AS base
...
RUN install-tool composer 2.3.8
