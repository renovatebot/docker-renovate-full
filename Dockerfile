...
ARG RENOVATE_VERSION=32.36.0

# Base image
#============
FROM renovate/buildpack:6@sha256:8215c00a586c7bd04f790c1921e764295239977e7cb74196907ab0be021263ab AS base
...
RUN install-pip pipenv 2022.4.30
...
RUN install-gem bundler 2.3.12
