...
ARG RENOVATE_VERSION=32.190.6

# Base image
#============
FROM renovate/buildpack:6@sha256:bdd2fc5f9567c472697e2bd21f8079bf259e0813e8873374f9f80667ae8f983c AS base
...
RUN install-pip pipenv 2022.9.4
