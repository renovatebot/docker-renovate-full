...
ARG RENOVATE_VERSION=37.13.0

# Base image
#============
FROM ghcr.io/containerbase/base:9.20.9@sha256:1ecfbadfd199c724e5b795260a996991f9d1e269f0fe57252461a8cb7a6798e1 AS base
...
RUN install-tool erlang 26.1.1.0
