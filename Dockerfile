...
ARG RENOVATE_VERSION=32.234.2

# Base image
#============
FROM renovate/buildpack:6@sha256:8b74cb13f61c3e785a61b65fca19998df24158b5b35cd42518b173b623e0fb32 AS base
...
RUN install-pip pipenv 2022.10.11
