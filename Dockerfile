...
ARG RENOVATE_VERSION=34.70.1

# Base image
#============
FROM ghcr.io/containerbase/buildpack:5.6.0@sha256:9793825e71fb29de5ca77b3205e070c54ca8ee6f628fca70439d122994141f2a AS base
