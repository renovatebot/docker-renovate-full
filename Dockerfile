...
ARG RENOVATE_VERSION=28.8.2

# Base image
#============
FROM renovate/buildpack:5@sha256:06831d3732e8d66580f5da09a849194517e6497a5862511f11103a097dad4c5f AS base
