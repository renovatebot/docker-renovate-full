...
ARG RENOVATE_VERSION=32.159.0

# Base image
#============
FROM renovate/buildpack:6@sha256:842260287a7117f2a326ef6fc0ec12e0abfdb502fc740b77c2dc5d6dfb0c1260 AS base
...
RUN install-pip pipenv 2022.8.14
