...
ARG RENOVATE_VERSION=32.0.1

# Base image
#============
FROM renovate/buildpack:6@sha256:2279a1ffacff20ecae97dc0c2050b03e6d5550ce3a21f9389b503565671af243 AS base
...
RUN install-tool erlang 22.3.4.20
