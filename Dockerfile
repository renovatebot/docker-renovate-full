...
ARG RENOVATE_VERSION=34.152.4

# Base image
#============
FROM ghcr.io/containerbase/buildpack:6.2.1@sha256:d226b4796e5e9b38f7b0c2ceff4d0fcf43f5a1cc19a0bd3ca918df9d0b870566 AS base
